package com.gugu.demo.highconcurrency.day08;
...
public class Demo04 {
    ...
    public static void main(String[] args) {
        ...
        Thread t1 = new Thread(threadGroup1, new Demo02.R1(), "t1");
        Thread t2 = new Thread(threadGroup1, new Demo02.R1(), "t2");
        t1.start();
        t2.start();

        ThreadGroup threadGroup2 = new ThreadGroup(threadGroup1, "thread-group-2");
        Thread t3 = new Thread(threadGroup2, new Demo02.R1(), "t3");
        Thread t4 = new Thread(threadGroup2, new Demo02.R1(), "t4");
        t3.start();
        t4.start();
